...
`SELECT 'CONSULTASIEBELREQ' TABELA, SYSDATE OPERACAO, 
...
CONSULTASIEBELREQ.VIVOQTDETROCAVENDAFIXO from CONSULTASIEBELREQ INNER JOIN DADOSPROPOSTADS ON  CONSULTASIEBELREQ.IDS_CONSULTASIEBELREQ = DADOSPROPOSTADS.IDS_CONSULTASIEBELREQ  and DADOSPROPOSTADS.NUMPROPOSTA = NUMPROPOSTA `;

/*
`SELECT 'CONSULTASIEBELRESP' TABELA, SYSDATE OPERACAO, SYSDATE DATA_STREAM, CONSULTASIEBELRESP.* 
