...
`SELECT 'SERASAB49PF' TABELA, 'INSERT' OPERACAO, 
...
SERASAB49PF.REQUEST_SCOREFRAUDE_UF from SERASAB49PF  INNER JOIN DADOSPROPOSTADS ON  SERASAB49PF.IDS_SERASAB49PF = DADOSPROPOSTADS.IDS_SERASAB49PF  and DADOSPROPOSTADS.IDS_DADOSPROPOSTADS = IDS_DADOSPROPOSTADS `;


/*
`SELECT 'SERASAB49PF' TABELA, 'INSERT' OPERACAO, SYSDATE DATA_STREAM, SERASAB49PF.* 
