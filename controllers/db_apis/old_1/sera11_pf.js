...
`SELECT 'SERA11_PF' TABELA, 'INSERT' OPERACAO, 
...
SERA11_PF.SYS_CREATEDATE from SERA11_PF  INNER JOIN DADOSPROPOSTADS ON  SERA11_PF.IDS_SERA11_PF = DADOSPROPOSTADS.IDS_SERA11_PF  and DADOSPROPOSTADS.IDS_DADOSPROPOSTADS = IDS_DADOSPROPOSTADS `;


/*
`SELECT 'SERA11_PF' TABELA, 'INSERT' OPERACAO, SYSDATE DATA_STREAM, SERA11_PF.* 
