...
`SELECT 'QUOTEITEM_DS' TABELA, 'INSERT' OPERACAO, 
...
QUOTEITEM_DS.TEXTFIELDVRNEGOCIADOSERVRC from QUOTEITEM_DS  INNER JOIN DADOSPROPOSTADS ON  quoteitem_ds.ids_analisecredito_reqds = dadospropostads.ids_analisecredito_reqds  and DADOSPROPOSTADS.IDS_DADOSPROPOSTADS = IDS_DADOSPROPOSTADS `;

/*
`SELECT 'QUOTEITEM_DS' TABELA, 'INSERT' OPERACAO, SYSDATE DATA_STREAM, QUOTEITEM_DS.* 
