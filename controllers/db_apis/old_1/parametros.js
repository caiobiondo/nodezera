...
`SELECT 'PARAMETROS' TABELA, 'INSERT' OPERACAO, 
...
PARAMETROS.VLRMINLIMITEGWSAAS from PARAMETROS  INNER JOIN DADOSPROPOSTADS ON  PARAMETROS.IDS_PARAMETROS = DADOSPROPOSTADS.IDS_PARAMETROS  and DADOSPROPOSTADS.IDS_DADOSPROPOSTADS = IDS_DADOSPROPOSTADS `;


/*
`SELECT 'PARAMETROS' TABELA, 'INSERT' OPERACAO, SYSDATE DATA_STREAM, PARAMETROS.*
