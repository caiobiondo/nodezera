...
`SELECT
'ANALISECREDITO_RESPDS' TABELA , SYSDATE OPERACAO,
...
ON TELEFONICA.ANALISECREDITO_RESPDS.IDS_ANALISECREDITO_RESPDS = TELEFONICA.DADOSPROPOSTADS.IDS_ANALISECREDITO_RESPDS and DADOSPROPOSTADS.NUMPROPOSTA = NUMPROPOSTA`; 

/*
`SELECT 'ANALISECREDITO_RESPDS' TABELA, SYSDATE OPERACAO, SYSDATE DATA_STREAM, ANALISECREDITO_RESPDS.* 
