...
`SELECT 'RELATO' TABELA, SYSDATE OPERACAO, 
RELATO.IDS_RELATO ,
...
RELATO.REGISTROCONSULTAS_9_QUANTIDADE from RELATO  INNER JOIN DADOSPROPOSTADS ON  RELATO.IDS_RELATO = DADOSPROPOSTADS.IDS_RELATO  and DADOSPROPOSTADS.NUMPROPOSTA = NUMPROPOSTA `;


/*
`SELECT 'RELATO' TABELA, SYSDATE OPERACAO, SYSDATE DATA_STREAM, RELATO.* 
