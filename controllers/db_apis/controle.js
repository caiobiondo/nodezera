...
`SELECT 'CONTROLE' TABELA, SYSDATE OPERACAO, 
...
CONTROLE.USUARIOBLOCK from CONTROLE INNER JOIN DADOSPROPOSTADS ON  CONTROLE.IDS_CONTROLE = DADOSPROPOSTADS.IDS_CONTROLE  and DADOSPROPOSTADS.NUMPROPOSTA = NUMPROPOSTA `;


/*
`SELECT 'CONTROLE' TABELA, SYSDATE OPERACAO, SYSDATE DATA_STREAM, CONTROLE.* 
