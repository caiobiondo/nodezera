...
`SELECT 'WHITELIST_PF' TABELA, SYSDATE OPERACAO, 
...
WHITELIST_PF.NOMECLIENTE from WHITELIST_PF  INNER JOIN DADOSPROPOSTADS ON  WHITELIST_PF.IDS_WHITELIST_PF = DADOSPROPOSTADS.IDS_WHITELIST_PF  and DADOSPROPOSTADS.NUMPROPOSTA = NUMPROPOSTA `;

/*
`SELECT 'WHITELIST_PF' TABELA, SYSDATE OPERACAO, SYSDATE DATA_STREAM, WHITELIST_PF.* 
