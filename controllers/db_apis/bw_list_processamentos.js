...
BW_LIST_PROCESSAMENTOS.IDS_DADOSPROPOSTADS from BW_LIST_PROCESSAMENTOS INNER JOIN DADOSPROPOSTADS ON  BW_LIST_PROCESSAMENTOS.IDS_DADOSPROPOSTADS = DADOSPROPOSTADS.IDS_DADOSPROPOSTADS  and DADOSPROPOSTADS.NUMPROPOSTA = NUMPROPOSTA `;



/*
`SELECT 'BW_LIST_PROCESSAMENTOS' TABELA, SYSDATE OPERACAO, SYSDATE DATA_STREAM, BW_LIST_PROCESSAMENTOS.* 
