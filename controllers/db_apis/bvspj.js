...
`SELECT 'BVSPJ' TABELA, SYSDATE OPERACAO, 
BVSPJ.IDS_BVSPJ ,
...
BVSPJ.ADMINISTRADOR3_FLAGRESTR from BVSPJ INNER JOIN DADOSPROPOSTADS ON  BVSPJ.IDS_BVSPJ = DADOSPROPOSTADS.IDS_BVSPJ  and DADOSPROPOSTADS.NUMPROPOSTA = NUMPROPOSTA `;

/*
`SELECT 'BVSPJ' TABELA, SYSDATE OPERACAO, SYSDATE DATA_STREAM, BVSPJ.* 
