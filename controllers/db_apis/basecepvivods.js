...
`SELECT 'BASECEPVIVODS' TABELA, SYSDATE OPERACAO, 
...
TELEFONICA.BASECEPVIVODS.VL_OFERTA_MIGRACAO from BASECEPVIVODS INNER JOIN DADOSPROPOSTADS ON  BASECEPVIVODS.IDS_BASECEPVIVODS = DADOSPROPOSTADS.IDS_BASECEPVIVODS  and DADOSPROPOSTADS.NUMPROPOSTA = NUMPROPOSTA `;

/*
`SELECT 
'BASECEPVIVODS' TABELA, SYSDATE OPERACAO, 
...
/*`SELECT 
'BLACKLIST_PF_FIXO' TABELA, SYSDATE OPERACAO, SYSDATE DATA_STREAM, 
BLACKLIST_PF_FIXO.* 
