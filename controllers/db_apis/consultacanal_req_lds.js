...
`SELECT 'CONSULTACANAL_REQ_LDS' TABELA, SYSDATE OPERACAO, 
...
CONSULTACANAL_REQ_LDS.USUARIOSERASA from CONSULTACANAL_REQ_LDS INNER JOIN DADOSPROPOSTADS ON  CONSULTACANAL_REQ_LDS.IDS_CONSULTACANAL_REQ_LDS = DADOSPROPOSTADS.IDS_CONSULTACANAL_REQ_LDS  and DADOSPROPOSTADS.NUMPROPOSTA = NUMPROPOSTA`;


/*
`SELECT 'CONSULTACANAL_REQ_LDS' TABELA, SYSDATE OPERACAO, SYSDATE DATA_STREAM, CONSULTACANAL_REQ_LDS.* 
